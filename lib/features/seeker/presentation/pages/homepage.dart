...
import 'package:abodesv1/features/seeker/presentation/pages/settings.dart';
import 'package:abodesv1/features/chat/messages_list.dart';
import 'package:go_router/go_router.dart';
import 'package:firebase_auth/firebase_auth.dart';
import '../../../listings/apartments.dart';
...
class SeekerHomePage extends StatefulWidget {
  ...
  const SeekerHomePage({super.key, this.ownerId, this.seekerId});
  ...
  void _onBottomNavTapped(int index) async {
    ...
    switch (index) {
      ...
      case 3:
        ...
        break;
      case 4:
        context.go('/seeker/settings', extra: {
          'role': 'seeker',
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Hi ${widget.seekerId ?? "Seeker"}', style: textTheme.titleSmall),
